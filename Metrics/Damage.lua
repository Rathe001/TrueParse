...
local function addDamage(seg, srcGUID, dstFlags, amount, overkill)
	if not amount then
		return
	end
...
tracker.subevents.SWING_DAMAGE = function(seg, srcGUID, dstGUID, srcFlags, dstFlags, a1, a2)
	addDamage(seg, srcGUID, dstFlags, a1, a2)
end
...
local function spellDamage(seg, srcGUID, dstGUID, srcFlags, dstFlags, a1, a2, a3, a4, a5)
	addDamage(seg, srcGUID, dstFlags, a4, a5)
end
